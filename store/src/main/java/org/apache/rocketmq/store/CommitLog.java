...
public class CommitLog {
    ...
    // 这里是queueid是write queue, queueOffset从这边取
     ...
     *  正常情况下找到最近有效的消息offset，还原flushedWhere/committedWhere, 并且清除offset之后的脏文件
     */
    ...
    public PutMessageResult putMessage(final MessageExtBrokerInner msg) {
        ...
        try {
            ...
            // 打算写入file，DefaultAppendMessageCallback.doAppend
    ...
    class CommitRealTimeService extends FlushCommitLogService {
        ...
        public void run() {
            ...
            while (!this.isStopped()) {
                ...
                // 策略：200ms间隔commit或者满4个page再commit
    ...
    class DefaultAppendMessageCallback implements AppendMessageCallback {
        ...
        public AppendMessageResult doAppend(final long fileFromOffset, final ByteBuffer byteBuffer, final int maxBlank,
            ...
            switch (tranType) {
                ...
                // consumer queue
                // 如果是prepared 消息，把prepared表offset设置成queueOffset，后续update再从queueOffset取出
                case MessageSysFlag.TRANSACTION_PREPARED_TYPE:
                    if (defaultMessageStore.getMessageStoreConfig().isTransactionEnable() && defaultMessageStore.getMessageStoreConfig().isUseFileTransaction()) {
