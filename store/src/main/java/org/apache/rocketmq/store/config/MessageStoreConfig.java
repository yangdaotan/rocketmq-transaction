...
public class MessageStoreConfig {
    ...
    // transcation redoLog file size, default is 20w;
    private int tranRedoLogMappedFileSize = 200000 * ConsumeQueue.CQ_STORE_UNIT_SIZE;
    // transaction state table file size, default is 20w;
    private int tranStateTableMappedFileSize = 200000 * FileTransactionStateService.TSS_STORE_UNIT_SIZE;
    ...
    private boolean useFileTransaction = true;
    ...
    public boolean isUseFileTransaction() {
        return useFileTransaction;
    }

    public void setUseFileTransaction(boolean useFileTransaction) {
        this.useFileTransaction = useFileTransaction;
    }
    ...
    public int getTranRedoLogMappedFileSize() {
        return tranRedoLogMappedFileSize;
    }

    public void setTranRedoLogMappedFileSize(int tranRedoLogMappedFileSize) {
        this.tranRedoLogMappedFileSize = tranRedoLogMappedFileSize;
    }
